...
class RbacController extends Controller
{
    public function actionInit()
    {
        ...
        //--------------RULES
        //Rule Listing
        $listingRule = new \common\rbac\ListingRule();
        $auth->add($listingRule);
        ...
        //LISTINGS  
        //Permission to create a listing
        $createListing = $auth->createPermission('createListing');
        $createListing->description = 'Create Listings';
        $auth->add($createListing);

        //Permission to update a listing
        $updateListing = $auth->createPermission('updateListing');
        $updateListing->description = 'Update Listing';
        $auth->add($updateListing);

        //Permission to update own listing
        $updateOwnListing = $auth->createPermission('updateOwnListing');
        $updateOwnListing->description = 'Update Own Listing';
        $updateOwnListing->ruleName = $listingRule->name;
        $auth->add($updateOwnListing);
        $auth->addChild($updateOwnListing, $updateListing);

        //Permission to unfollow a listing
        $unfollowListing = $auth->createPermission('unfollowListing');
        $unfollowListing->description = 'Unfollow Listing';
        $unfollowListing->ruleName = $followRule->name;
        $auth->add($unfollowListing);
        ...
        $auth->addChild($user, $unfollowListing);
        ...
        $auth->addChild($user, $createListing);
        $auth->addChild($user, $createPromotion);
        $auth->addChild($user, $createEvent);
        $auth->addChild($user, $updateOwnListing);
        $auth->addChild($user, $updateOwnPromotion);
        $auth->addChild($user, $updateOwnBid);
        ...
        $auth->addChild($moderator, $updateListing);
