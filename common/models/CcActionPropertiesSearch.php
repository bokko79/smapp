...
/**
 * CcMethodsSearch represents the model behind the search form about `common\models\CcActionProperties`.
 */
class CcActionPropertiesSearch extends CcActionProperties
{
    /**
     * @inheritdoc
     */
