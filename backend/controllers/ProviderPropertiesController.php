...
use common\models\CcProviderPropertiesSearch;
 ...
 */
class ProviderPropertiesController extends Controller
{
    //public $layout = '/admin';
    ...
    {
        $searchModel = new CcProviderPropertiesSearch();
    ...
    {
        if (($model = CcProviderProperties::findOne($id)) !== null) {
            return $model;
        } else {
