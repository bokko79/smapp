    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'format' => 'raw',
                'value'=>function ($data) {
                    return $data->object ? Html::a($data->object->name, Url::to(['/objects/view', 'id'=>$data->object_id]), []) : null;
                },
            ],
            [
                ...
                'format' => 'raw',
                'value'=>function ($data) {
                    return Html::a($data->property->name, Url::to(['/properties/view', 'id'=>$data->property_id]), []);
                },
            ],
            [
