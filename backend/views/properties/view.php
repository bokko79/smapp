        ...
        <div class="col-sm-8">
            <div class="card_container record-full grid-item fadeInUp animated" id="card_container">
                <div class="primary-context gray normal">
                    <div class="head"><?= ($model->propertyValues) ? Html::a('Property Values', Url::to(['/property-values/index', 'CcPropertyValuesSearch[property_id]'=>$model->id]), []) : 'Property Values' ?></div>
                    <div class="subhead"><?= Html::a('New Property Value', ['/property-values/create', 'CcPropertyValuesSearch[property_id]' => $model->id], ['class' => 'btn btn-warning btn-sm']) ?></div>
                </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="card_container record-full grid-item fadeInUp animated" id="card_container">
            <div class="primary-context gray normal">
                <div class="head"><?= ($model->objectProperties) ? Html::a('Object Properties', Url::to(['/object-properties/index', 'CcObjectProperties[property_id]'=>$model->id]), []) : 'Object Properties' ?></div>
                <div class="subhead"><?= Html::a('New Object Property', ['/object-properties/create', 'CcObjectProperties[property_id]' => $model->id], ['class' => 'btn btn-warning btn-sm']) ?></div>
            </div>
            <div class="secondary-context">
            <?php      Pjax::begin(); ?>    
                <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'value'=>function ($data) {
                                    return Html::a($data->object->name, ['object-properties/view', 'id' => $data->id]);
                                },
                            ],
                            [
                                'label'=>'Unit',
