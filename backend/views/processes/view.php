...
<?= Html::a('New Task', ['/process-tasks/create', 'CcProcessTasks[process_id]' => $model->id], ['class' => 'btn btn-warning btn-sm']) ?>
    ...
    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'format' => 'raw',
                                'value'=>function ($data) {
                                    return Html::a($data->name, ['process-tasks/view', 'id' => $data->id]);
                                },
                            ],
                            'name',
                            [
